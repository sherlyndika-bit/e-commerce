          ...
          <div className="mb-6 p-3 bg-brand-50/70 dark:bg-brand-950/30 rounded-2xl border border-brand-200/60 dark:border-brand-900/40">
            ...
            <div className="grid grid-cols-3 gap-1.5 text-xs">
              ...
              <button
                ...
                className="py-1.5 px-2 rounded-xl bg-white dark:bg-slate-800 hover:bg-pink-600 hover:text-white font-bold text-[11px] text-slate-800 dark:text-slate-200 shadow-2xs transition-colors"
              >
                🏪 Seller
              </button>
              <button
