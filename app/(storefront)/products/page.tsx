      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-1.5 text-xs text-slate-400 mb-4">
          ...
          {filterState.categorySlug && (
            <>
              <ChevronRight className="w-3 h-3" />
              <span className="text-pink-600 font-bold capitalize">
        ...
        <div className="lg:hidden mb-3">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-2 px-4 rounded-lg bg-white border border-slate-200 text-slate-800 font-bold text-xs shadow-2xs"
          >
