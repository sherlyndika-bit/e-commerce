      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-4 md:grid-cols-6 lg:grid-cols-6 gap-x-2 sm:gap-x-6 lg:gap-x-8 gap-y-8 px-2 max-w-4xl mx-auto justify-items-center">
          {mockCategories.map((cat) => (
            ...
            >
              <div className="relative w-[72px] h-[72px] rounded-full bg-pink-50 text-pink-500 flex items-center justify-center mb-3 border border-pink-100 transition-all duration-200 group-hover:border-pink-300 shrink-0 p-2.5">
                <img src={cat.imageIcon} alt={cat.name} className="w-full h-full object-contain group-hover:scale-110 transition-transform duration-300" />
